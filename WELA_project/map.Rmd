...
A traves de nuestro mapa interactivo puedes buscar por palabras clave, ciudades, instituciones, disciplinas, idiomas, etc., y también filtrar los registros por área de investigación, país o posición (se refiere a la etapa general de la carrera de la experta).
...
icon.mw <- makeIcon(
  iconUrl = "stock_vector_jaguar_set_vector.png",
