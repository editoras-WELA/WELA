...
datos <- dat %>%
  ...
  dplyr::select(`Nombre/Nome`, `Posición/Posição`, `País de residencia actual / País de residência atual`,`Estudios/Estudos`, `Área de trabajo / Área de trabalho`,`Universidad/Institución/Organización/Universidade/ Instituição/Organização actual`,`Idioma/Língua`, `E-mail`, Twitter, `Palabras clave / Palavras-chave`, `Experiencia como editora/Experiência de editor`) 
